        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="dgm-about-thumb-wrap p-relative">
                    <img class="tp_fade_anim" data-delay=".3" data-fade-from="left" src="{{ asset('assets/img/about-us/about-us/two-business-woman-cafe.jpg') }}" alt="">
            ...
            <div class="col-lg-6">
                <div class="dgm-about-right">
                    <div class="dgm-about-title-box z-index-1 mb-35">
                        <span class="tp-section-subtitle subtitle-black mb-15 tp_fade_anim" data-delay=".3">Who We Are</span>
                    ...
                    <div class="dgm-about-content">
                        ...
                        <div class="tp_fade_anim" data-delay=".5">
                            <a class="tp-btn-yellow-green green-solid btn-60 mb-50" href="about-us-light.html">
                                <span>
                                    <span class="text-1">Give us a call</span>
                                    <span class="text-2">Give us a call</span>
                                </span>
                                <i>
...
<div class="it-about-area it-about-ptb pt-140 pb-90 p-relative">
    <div class="it-about-shape-wrap">
        <img data-speed="1.1" class="it-about-shape-1 d-none d-xxl-block" src="assets/img/home-11/about/about-shape-1.png" alt="" data-lag="0" style="translate: none; rotate: none; scale: none; transform: translate(0px, 53.1364px); will-change: transform;">
        <img data-speed=".9" class="it-about-shape-2" src="assets/img/home-11/about/about-shape-2.png" alt="" data-lag="0" style="translate: none; rotate: none; scale: none; transform: translate(0px, 16.0501px); will-change: transform;">
    </div>
    <div class="container container-1920">
        <div class="row">
            <div class="col-xl-6">
                <div class="it-about-title-box z-index-2">
                    <h4 class="tp-section-title-platform platform-text-black fs-84 mb-30 tp-split-text tp-split-right" style="perspective: 400px;">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea magnam obcaecati 
                    </h4>
                    <div class="tp_text_anim">
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. At earum maxime odit itaque eius corrupti deleniti voluptas praesentium! Nisi sed quos fuga laboriosam optio minus ab maiores laudantium minima quam?</p>
                    </div>
                    <div class="tp_fade_anim" data-fade-from="top" data-ease="bounce" style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                        <a class="tp-btn-black-radius btn-blue-bg  d-inline-flex align-items-center justify-content-between mr-15" href="services">
                            <span>
                                <span class="text-1">Explore Our Service</span>
                                <span class="text-2">Explore Our Service</span>
                            </span>
                            <i>
                                <span>
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 11L11 1M11 1H1M11 1V11" stroke="#21212D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 11L11 1M11 1H1M11 1V11" stroke="#21212D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                        ...
                        <div class="it-about-thumb">
                            <div class="p-relative">
                                <div class="it-about-thumb-inner mb-50">
                                    <img class="img-1" data-speed=".9" src="assets/img/home-11/about/about-1.jpg" alt="" data-lag="0" style="translate: none; rotate: none; scale: none; transform: translate(0px, -2.99988px); will-change: transform;">
                                </div>
                                <div class="it-about-info-wrap">
                                    <div class="it-about-info-item d-inline-flex align-items-center" data-parallax="{&quot;x&quot;: 50, &quot;smoothness&quot;: 30}" style="transform:translate3d(37.429px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(37.429px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
                                        <i><span>15</span>+</i>
                                        <p>Years of <br> Experience</p>
                                    </div>
                                    <div class="it-about-info-item d-inline-flex align-items-center" data-bg-color="#DACBFF" data-parallax="{&quot;x&quot;: -50, &quot;smoothness&quot;: 30}" style="transform:translate3d(-28.19px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(-28.19px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); background-color: rgb(218, 203, 255);">
                                        <i><span>61</span>+</i>
                                        <p>Projects <br> Worldwide</p>
                                    </div>
                                </div>
                            </div>
                            <img class="img-2 mb-100" src="assets/img/home-11/about/about-2.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="it-about-thumb">
                            <img class="img-3" data-speed="1.1" src="{{ asset('assets/img/about-us/about-us/about-us.jpg') }}" alt="" data-lag="0" style="translate: none; rotate: none; scale: none; transform: translate(0px, 44.5499px); will-change: transform;">
                        </div>
                    </div>
                </div>
            </div>
