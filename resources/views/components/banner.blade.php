                    ...
                    <div class="dgm-hero-ptb grey-bg-2 fix z-index-1 p-relative">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="dgm-hero-content mb-120">
                                        <span class="dgm-hero-subtitle tp_fade_anim" data-delay=".3"> <span></span>FORTS & HUBS GLOBAL INC.</span>
                                        <h3 class="dgm-hero-title tp_fade_anim" data-delay=".5">
                                            {{ $slide->title }}
                                        </h3>
                        ...
                        <div class="dgm-hero-thumb anim-zoomin-wrap">
                            <div class="anim-zoomin">
                                <img src="{{ asset('storage/' . $slide->image_path) }}" alt="">
                            </div>
                            <div class="dgm-hero-text-box" data-background="assets/img/home-03/hero/hero-text-shape.png">
                                {{-- <img src="assets/img/home-03/hero/hi-shape.png" alt=""> --}}
                                <a class="dgm-hero-arrow" href="contact.html">
                                    <span>
                        ...
                        <div class="container container-1430">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="dgm-hero-content mb-120">
                                        <span class="dgm-hero-subtitle tp_fade_anim" data-delay=".3">🔥 BEST MARKETING AGENCY</span>
                                        <h4 class="dgm-hero-title tp_fade_anim" data-delay=".5">
                                            Digital <img class="dgm-hero-title-mike d-none d-md-inline-block" src="assets/img/home-03/hero/mike.png" alt="">
                                            marketing agency
                                        </h4>
                                        <div class="tp_fade_anim" data-delay=".7">
                                            <a class="tp-btn-black-square" href="contact-us">
                        ...
                        <div class="dgm-hero-thumb anim-zoomin-wrap">
                            <div class="anim-zoomin">
                                <img src="assets/img/home-03/hero/hero-img.jpg" alt="">
                            </div>
                            <div class="dgm-hero-text-box" data-background="assets/img/home-03/hero/hero-text-shape.png">
                                <img src="assets/img/home-03/hero/hi-shape.png" alt="">
